package com.example.aiyang.baidumapapp;
...
import com.example.aiyang.baidumapapp.UI.BaseActivity;
...
public class MainActivity extends BaseActivity implements SensorEventListener,View.OnClickListener {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        setCircleOptions(); //2、设置打卡范围圈 (Demo以定位坐标附近位置作为目的地)

        getLocationClientOption();//3、定位开启
    ...
    private void initBaiduMap() {
        ...
        mBaiduMap.animateMapStatus(MapStatusUpdateFactory.zoomBy(15));//缩放
    }
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (mDistance <= DISTANCE) {
                ...
                //按钮颜色
//                mAriiverBt.setBackgroundDrawable(getResources().getDrawable(R.mipmap.restaurant_btbg_yellow));
            } else {
                setTextOption(LocationPoint, "您不在餐厅范围之内", "#FF6C6C");
                setMarkerOptions(mDestinationPoint, R.mipmap.restaurant_icon);
//                mAriiverBt.setBackgroundDrawable(getResources().getDrawable(R.mipmap.restaurant_btbg_gray));
            }
            mDistance_tv.setText("距离目的地："+mDistance);
            //缩放地图
    ...
    private void setMapZoomScale(LatLng ll) {
        ...
        if (mZoomScale == 0) {
            ...
            MapStatusUpdate mapStatusUpdatePoint = MapStatusUpdateFactory.newLatLngZoom(mCenterPos, mZoomScale);
    ...
    private Runnable run = new Runnable() {
        ...
        public void run() {
            ...
            mTime_tv.setText(sysTimeStr); //更新时间
